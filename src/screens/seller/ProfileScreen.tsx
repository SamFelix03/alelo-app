...
const SellerProfileScreen = () => {
  ...
  useEffect(() => {
    if (userInfo?.profileData) {
      ...
      setEditLogo(userInfo.profileData.logo_url || null);
    ...
    try {
      ...
      if (!result.canceled && result.assets[0]) {
        ...
        try {
          ...
          const fileName = `sellers/${userInfo?.phoneNumber?.replace(/[^\w]/g, '_')}/${Date.now()}.${ext}`
  ...
  const updateProfilePicture = async (logoUrl: string) => {
    try {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileCard}>
          <View style={styles.profileImageContainer}>
            <Image
              source={{ 
                uri: userInfo?.profileData?.logo_url || "https://via.placeholder.com/120?text=" + (userInfo?.profileData?.name?.charAt(0) || "B")
              }}
        ...
        <View style={styles.statusCard}>
          <View style={styles.statusHeader}>
            <View style={styles.statusIconContainer}>
              <DocumentTextIcon 
                size={24} 
                color={isOpen ? theme.colors.primary : theme.colors.placeholder} 
              />
            </View>
            <View style={styles.statusTextContainer}>
              <Text style={styles.statusTitle}>Business Status</Text>
              <Text style={styles.statusSubtitle}>
                {isOpen ? "Open and visible to customers" : "Closed - not visible to customers"}
              </Text>
            </View>
            <Switch
              value={isOpen}
            ...
            >
              <View style={styles.settingLeft}>
                ...
                <View>
                  ...
                  <Text style={styles.settingSubtitle}>Get notified about new orders</Text>
                </View>
              </View>
              <Switch
        ...
        <View style={styles.settingsSection}>
          ...
          <View style={styles.settingsCard}>
            ...
            <View style={styles.infoItem}>
              <View style={styles.settingLeft}>
                <View style={styles.settingIconContainer}>
                  <BuildingOfficeIcon size={20} color={theme.colors.primary} />
                </View>
                <View>
                  <Text style={styles.settingTitle}>Account Type</Text>
                  <Text style={styles.settingSubtitle}>Business Seller</Text>
                </View>
              </View>
            </View>
          </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.modalImageSection}>
                ...
                >
                  <Image
                    source={{ 
                      uri: editLogo || "https://via.placeholder.com/100?text=" + (editName?.charAt(0) || "B")
                    }}
                ...
                <Text style={styles.imageHint}>Tap to change logo</Text>
              </View>
